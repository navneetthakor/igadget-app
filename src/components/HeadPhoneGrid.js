    ...
    <>
      {load ? (
        <div className="bg2 DisableCss">
          <div className="ContainerFrame container flexRow topmargin FlexCol">
            {/* ---heading for mobile devices-------- */}
            <h1 className="PrimeHeading disableCss DisBlockCss">
              HeadPh Collection
            </h1>
            ...
            {/* image division  */}
            <div
              className="gV1Image marginLeft DisableCss"
              onClick={searchData}
            >
